...
export const faqs: Record<Language, Record<FaqPage, readonly FaqItem[]>> = {
  en: {
    home: [
      ...
      ['What will I actually get from the 3-Month Growth Advisory?', 'You get a clear diagnosis of what is limiting growth, useful commercial targets, channel and budget priorities, an assessment of the agency and internal team, one practical growth plan and a review rhythm that keeps decisions moving. Your existing team and partners continue executing.'],
      ['How is Fractional Head of Growth different from advisory?', 'With advisory, your existing growth leader remains responsible and I improve the quality of the decisions around them. As Fractional Head of Growth, I actively direct agencies and specialists, lead the weekly growth rhythm and take responsibility for keeping the complete plan accountable.'],
      ['Will you replace my current agency or media buyer?', 'Not automatically. I first determine whether the constraint is the strategy, the agency, the internal team, measurement, conversion, retention or something else. If the agency is capable, I help give it clearer targets and direction. If it is the constraint, I will explain why.'],
  ...
  pt: {
    home: [
      ...
      ['O que recebo concretamente no Advisory de Crescimento de 3 Meses?', 'Recebe um diagnóstico claro do que limita o crescimento, objetivos comerciais úteis, prioridades de canal e orçamento, uma avaliação da agência e da equipa interna, um plano prático e um ritmo de revisão que mantém as decisões em movimento. A equipa e os parceiros atuais continuam a executar.'],
      ['Qual é a diferença entre advisory e Head of Growth Fracional?', 'No advisory, o líder de crescimento atual continua responsável e eu melhoro a qualidade das decisões à sua volta. Como Head of Growth Fracional, dirijo ativamente agências e especialistas, lidero o ritmo semanal e assumo a responsabilidade por manter o plano completo sob controlo.'],
      ['Vai substituir a minha agência ou media buyer?', 'Não automaticamente. Primeiro determino se o bloqueio está na estratégia, agência, equipa interna, medição, conversão, retenção ou noutro ponto. Se a agência for competente, ajudo a dar-lhe objetivos e direção mais claros. Se for o bloqueio, explico porquê.'],
  ...
  es: {
    home: [
      ...
      ['¿Qué recibo exactamente en la Asesoría de Crecimiento de 3 Meses?', 'Recibes un diagnóstico claro de lo que limita el crecimiento, objetivos comerciales útiles, prioridades de canal y presupuesto, una evaluación de la agencia y el equipo interno, un plan práctico y un ritmo de revisión que mantiene las decisiones en movimiento. El equipo y los socios actuales siguen ejecutando.'],
      ['¿Cuál es la diferencia entre asesoría y Head of Growth Fraccional?', 'En la asesoría, el líder de crecimiento actual sigue siendo responsable y yo mejoro la calidad de las decisiones a su alrededor. Como Head of Growth Fraccional, dirijo activamente agencias y especialistas, lidero el ritmo semanal y asumo la responsabilidad de mantener el plan completo bajo control.'],
      ['¿Vas a sustituir a mi agencia o media buyer?', 'No automáticamente. Primero determino si el obstáculo está en la estrategia, agencia, equipo interno, medición, conversión, retención u otro punto. Si la agencia es competente, ayudo a darle objetivos y dirección más claros. Si es el obstáculo, explicaré por qué.'],
