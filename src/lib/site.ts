...
export const copy = {
  en: {
    ...
    heroBody: 'I help founders find what is holding growth back, get the right people working on it, and turn disconnected marketing into one clear plan.',
    ...
    scenarios: [
      ['The strategy is unclear', 'The team is executing without clear goals, economics, priorities or channel roles.'],
      ['The agency is the constraint', 'The agency lacks the competence, focus or accountability required for the company’s stage.'],
      ['The internal team needs leadership', 'The team needs paid-channel knowledge, clearer ownership and stronger commercial direction.']
    ],
  ...
  pt: {
    ...
    hero: 'A próxima fase de crescimento precisa de alguém que já o fez antes.', heroBody: 'Ajudo fundadores a descobrir o que bloqueia o crescimento, colocar as pessoas certas a trabalhar no problema e transformar marketing desligado num plano claro.', secondary: 'Veja como trabalho', stats: [['7 anos', 'a liderar uma agência de performance marketing'], ['130 marcas', 'em várias indústrias'], ['$250M+', 'receita anual da maior empresa que aconselhei']], logoTitle: 'Marcas com que trabalhei',
    ...
    constraintTitle: 'O problema visível nem sempre é o verdadeiro bloqueio.', constraintIntro: 'O meu trabalho é determinar qual situação existe antes de prescrever uma solução.', scenarios: [['A estratégia não é clara', 'A equipa executa sem objetivos, economia, prioridades ou funções de canal claras.'], ['A agência é o bloqueio', 'A agência não tem a competência, o foco ou a responsabilidade exigida nesta fase.'], ['A equipa interna precisa de liderança', 'A equipa precisa de conhecimento de canais pagos, responsabilidade clara e uma direção comercial mais forte.']],
  ...
  es: {
    ...
    hero: 'La siguiente etapa de crecimiento necesita a alguien que ya lo haya hecho antes.', heroBody: 'Ayudo a fundadores a descubrir qué frena el crecimiento, poner a las personas adecuadas a resolverlo y convertir un marketing desconectado en un plan claro.', secondary: 'Descubre cómo trabajo', stats: [['7 años', 'dirigiendo una agencia de performance marketing'], ['130 marcas', 'en múltiples industrias'], ['$250M+', 'facturación anual de la mayor empresa asesorada']], logoTitle: 'Marcas con las que he trabajado',
    ...
    constraintTitle: 'El problema visible no siempre es el verdadero obstáculo.', constraintIntro: 'Mi trabajo es determinar qué situación existe antes de prescribir una solución.', scenarios: [['La estrategia no está clara', 'El equipo ejecuta sin objetivos, economía, prioridades o funciones de canal claras.'], ['La agencia es el obstáculo', 'La agencia carece de la competencia, el foco o la responsabilidad necesarios para esta etapa.'], ['El equipo interno necesita liderazgo', 'El equipo necesita conocimiento de canales de pago, responsabilidades claras y una dirección comercial más fuerte.']],
