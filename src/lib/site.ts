...
export const copy = {
  ...
  pt: {
    ...
    hero: 'A próxima fase de crescimento precisa de alguém que já o tenha feito.', heroBody: 'Ajudo fundadores a identificar o que está a travar o crescimento, alinhar equipas e agências e transformar canais dispersos num plano claro.', secondary: 'Veja como trabalho', stats: [['7 anos', 'a liderar uma agência de performance marketing'], ['130 marcas', 'em várias indústrias'], ['$250M+', 'receita anual da maior empresa que aconselhei']], logoTitle: 'Marcas com que trabalhei',
